...
const FooterSection = styled.footer`
  width: 100%;
  background: #f4f7fb; /* Seamless very light gray */
...
const LogoCol = styled.div`
  ...
  align-items: flex-start;
  font-size: 1.13rem;
  background: #f4f7fb;    /* Match the footer! */
  border-radius: 22px;
  ...
  return (
    <FooterSection>
      <Container>
        <LogoCol>
          <Logo>
            <LogoImg src="/SnowLEXlogo/NoBackgroundLogo.png" alt="Snowlex logo" />
          </Logo>
          <LogoDesc>
            Lorem ipsum dolor sit amet consectetur adipising elit aliquam mauris sed mo
          </LogoDesc>
          <SocialRow>
